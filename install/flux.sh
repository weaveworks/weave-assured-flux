...
# This script was originally copied from https://raw.githubusercontent.com/fluxcd/flux2/main/install/install.sh
# and modified to support the Weave Assured Flux distribution.

DEFAULT_BIN_DIR="/usr/local/bin"
BIN_DIR=${1:-"${DEFAULT_BIN_DIR}"}
GITHUB_REPO="weaveworks/weave-assured-flux"
